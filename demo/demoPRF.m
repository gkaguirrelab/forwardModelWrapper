...
[hcpStructPath,nativeSpaceDirPath,pseudoHemiDirPath] = mainPRF(funcZipPath, stimFilePath, structZipPath, ...
...
inferredSpaceDirPath = fullfile(outPath, 'maps_inferredMGZ');
if ~exist(inferredSpaceDirPath,'dir')
    mkdir(inferredSpaceDirPath);
end
...
command = ['python3 -m neuropythy register_retinotopy ' hcpStructPath ...
    ' --surf-outdir=' inferredSpaceDirPath ...
