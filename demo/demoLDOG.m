...
outputFileSuffix = '_preprocessedFunc.zip';
...
searchStruct = struct(...
    'returnType', 'analysis', ...
    'filters', {{...
    struct('match', struct('analysis0x2elabel', 'ldogfunc')), ...
    struct('match', struct('analysis0x2elabel', '16:02:15')), ...
...
searchStruct = struct(...
    'returnType', 'analysis', ...
    'filters', {{...
    struct('match', struct('session0x2elabel', 'LightFlux')), ...
