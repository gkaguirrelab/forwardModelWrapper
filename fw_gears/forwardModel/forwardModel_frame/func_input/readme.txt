...
================================
-mainPRF 
-run_mainPRF.sh (shell script for temporarily setting environment variables and executing 
                 the application)
   -to run the shell script, type
   
       ./run_mainPRF.sh <mcr_directory> <argument_list>
    ...
    /mathworks/home/application/v97, run the shell script as:
       ...
       ./run_mainPRF.sh /mathworks/home/application/v97
       
    If you have MATLAB installed in /mathworks/devel/application/matlab, 
    run the shell script as:
    
       ./run_mainPRF.sh /mathworks/devel/application/matlab
-MCRInstaller.zip
...
${LD_LIBRARY_PATH}:MR/v97/runtime/glnxa64:MR/v97/bin/glnxa64:MR/v97/sys/os/glnxa64:MR/v97/sys/opengl/lib/glnxa64
   ...
   Distribute in the MATLAB Compiler documentation in the MathWorks Documentation Center.
        ...
        NOTE: When deploying standalone applications, you can
              run the shell script file run_mainPRF.sh 
